...
// Use Google's modern JWKS endpoint directly instead of google-auth-library's
// verifyIdToken(), which calls the legacy /oauth2/v1/certs endpoint. That
// endpoint intermittently returns 403 for requests from shared cloud IP
// ranges (e.g. Render), causing "Google sign-in failed" even with a valid token.
