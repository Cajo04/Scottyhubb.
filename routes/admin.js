...
router.get('/stats', async (req, res) => {
  try {
    ...
    const activeListings = await db.execute("SELECT COUNT(*) as c FROM bots_marketplace WHERE status = 'approved'");
...
// Marketplace moderation now lives in routes/marketplace.js:
//   GET /api/marketplace/admin/pending
//   PUT /api/marketplace/admin/bots/:id
