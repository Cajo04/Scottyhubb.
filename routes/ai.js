...
const TOOL_PROMPTS = {
  chat: 'You are ScottyAI, a friendly and helpful assistant created by Scotty for Spider Hub — a digital income and WhatsApp bot platform from Zimbabwe. Help users with WhatsApp bots using Baileys.js, JavaScript, Node.js, deploying on Render/pxxl, making money online, and Spider Hub features. Always respond in English only. Never say you are DeepSeek or any other AI — you are ScottyAI. Be concise, friendly, and practical. Keep responses short and mobile-friendly.',
...
async function callOpenRouter(systemPrompt, messages) {
  const response = await fetch('https://openrouter.ai/api/v1/chat/completions', {
    ...
    headers: {
      ...
      'HTTP-Referer': 'https://spider-bot2.pxxl.run',
      'X-Title': 'Spider Hub AI'
    },
    body: JSON.stringify({
